...
1. 上传"redis-6.2.6.tar.gz"到Linux系统/soft目录下

2. 进入soft目录,将"redis-6.2.6.tar.gz"解压到当前目录
...
4. 在redis目录中，使用以下命令，将redis安装到/usr/local/redis指定的目录下
...
1. 将之前解压出来的/soft/redis-6.2.6/redis.conf 配置文件复制到安装好的/usr/local/redis/bin/目录下
