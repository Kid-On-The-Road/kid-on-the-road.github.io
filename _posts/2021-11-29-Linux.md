...
| ![img](https://raw.githubusercontent.com/Kid-On-The-Road/Resources/main/%E5%8D%9A%E5%AE%A2/%E5%9B%BE%E7%89%87/centos7/wpsC666.tmp.png) | Note that AIX only supports specifying buffer sizes of 1MB, 4MB, and 8MB. Additionally there is an issue with IBM's 1.4.2, and 1.5 JVMs which may prevent them from allocating socket buffers larger then 64K. This issue has been addressed in IBM's 1.4.2 SR7 SDK and 1.5 SR3 SDK. |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                                              |                                                              |
...
2、unzip jrockit-jdk1.6.0_29-R28.1.5-4.0.1.zip
...
#修改内容
su oracle -lc "/opt/oracle/product/11.2.0/bin/dbstart orcl1"
