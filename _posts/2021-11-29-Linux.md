...
#!/usr/bin/expect
#删除文件
spawn sudo ssh -t 192.168.88.4 "rm /usr/local/jboss-eap-7.3/standalone/deployments/testJboss.war"
expect "*sudo*" {send "GST\r"}
expect "*yes/no*" {send "yes\r"}
expect "*password:" {send "root\r"}
expect "*testJboss*" {send "exit\r"}
#复制文件
spawn sudo scp /var/lib/jenkins/workspace/jboss/web/build/libs/testJboss.war 192.168.88.4:/usr/local/jboss-eap-7.3/standalone/deployments
expect "*sudo*" {send "GST\r"}
expect "*yes/no*" {send "yes\r"}
expect "*password:" {send "root\r"}
expect "*testJboss*" {send "exit\r"}
